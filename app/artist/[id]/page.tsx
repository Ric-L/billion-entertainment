...
export default function VivekMorvadiaEPK() {
  ...
  // const youtubeUrl = "https://www.youtube.com/channel/UCG1BX23mRmCjW-7dutZRD1g";
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative h-screen">
        <div className="absolute inset-0">
          <Image src="/still2.png" alt="Vivek Morvadia" fill priority className="object-cover object-center ml-0 md:object-left md:ml-[100px]" />
        ...
        <div className="relative mr-10 z-10 h-full flex flex-col justify-center items-center text-center">
          ...
          <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold tracking-wider mb-4 text-white drop-shadow-2xl">VIVEK MORVADIA</h1>
          ...
          <div className="mt-8 text-white/60 text-sm tracking-widest">2000+ SHOWS • ORIGINAL MUSIC • COLLABORATIONS</div>
        </div>
      </section>
      ...
      <section className="relative min-h-screen bg-black p-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto flex justify-end">
          <div className="w-full lg:w-auto lg:max-w-2xl space-y-14 mt-16 p-4 rounded bg-gray-800 ml-auto mr-[50px]">
            <h2 className="text-4xl md:text-5xl font-bold tracking-wider text-white">BIOGRAPHY</h2>
            ...
            <div className="w-full max-w-xs mx-auto h-80 rounded-lg overflow-hidden relative shadow-2xl lg:hidden">
              <Image src="/1.png" alt="Vivek Morvadia Portrait" fill className="object-cover object-center" />
            </div>
          </div>
        </div>
...
//       <section className="relative h-screen">
//         <div className="absolute inset-0">
//           <Image src="/still2.png" alt="Vivek Morvadia" fill priority className="object-fill ml-[100px]" />
//           <div className="absolute inset-0 bg-gradient-to-br from-slate-900/80 via-slate-800/80 to-slate-900/80"></div>
//           <div className="absolute inset-0 bg-black/25"></div>
//         </div>
...
//         <div className="absolute inset-0 z-0">
//           <div className="relative w-full h-full">
//             <Image src="/u12.png" alt="Vivek Morvadia Portrait" fill priority className="object-cover object-left scale-105 -ml-[50px]" />
//             <div className="absolute inset-0 "></div>
//             <div className="absolute inset-0 "></div>
//           </div>
//         </div>
