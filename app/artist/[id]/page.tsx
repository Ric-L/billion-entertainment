  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="absolute top-6 left-6 z-50">
        <Link href="/" className=" ml-14 flex items-center space-x-2 px-4 py-2 rounded-full bg-white/10 hover:bg-white/20 transition-colors">
      ...
      <section className="relative h-screen">
        <div className="absolute inset-0">
          <Image src="/still2.png" alt="Vivek Morvadia" fill priority className="object-contain ml-[100px]" />
      ...
      <section className="relative min-h-screen bg-black p-8 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <div className="relative w-full h-full">
            <Image src="/1.png" alt="Vivek Morvadia Portrait" fill priority className="object-contain ml-[100px]" />
            <div className="absolute inset-0 bg-gradient-to-br from-slate-900/80 via-slate-800/80 to-slate-900/80"></div>
            <div className="absolute inset-0 bg-black/25"></div>
          </div>
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <p className="text-base leading-relaxed text-white/90 max-w-lg backdrop-blur-sm bg-white/5 p-4 rounded-lg">
