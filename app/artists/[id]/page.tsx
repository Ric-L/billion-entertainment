...
export default function ArtistEPK({ params }: PageProps) {
  ...
  const { name, role, location, genres, bio, fullBio, image, heroImage, stats = [], socials, services = [], accentColor } = artist;
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative h-screen">
        ...
        <div className="relative z-10 h-full flex flex-col justify-center items-center text-center">
          <div className="absolute top-8 right-8 flex items-center space-x-4">
            {socials.instagram && (
              <a href={socials.instagram} target="_blank" rel="noopener noreferrer" className="p-3 rounded-full hover:bg-white/20 transition-colors">
                <Instagram className="w-4 h-4" />
              </a>
            )}
            {socials.youtube && (
              <a href={socials.youtube} target="_blank" rel="noopener noreferrer" className="p-3 rounded-full hover:bg-white/20 transition-colors">
      ...
      {/* Media Section - Placeholder (customize per artist if needed) */}
      <section className="min-h-screen bg-gradient-to-t from-black via-purple-900 to-indigo-800 p-8">
        <div className="max-w-7xl mx-auto space-y-12">
          {socials.spotify && (
            <div className="space-y-4">
              ...
              <div className="rounded-xl overflow-hidden shadow-2xl">
                <iframe
                  src={`https://open.spotify.com/embed/artist/${socials.spotify.split("/").pop()}?utm_source=generator&theme=0`}
          ...
          {/* Add YouTube embeds, showreels, etc. as needed per artist */}
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-8 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            <div className="lg:col-span-2 space-y-6">
              <div className="flex items-center space-x-4">
                <div className={`w-16 h-16 bg-gradient-to-r from-${accentColor}-400 to-${accentColor}-600 rounded-full flex items-center justify-center`}>
