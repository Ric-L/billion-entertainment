	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-gray-900 via-cyan-950 to-gray-900 text-white">
			...
			<section className="relative min-h-screen flex items-center justify-center pt-16">
				...
				<div className="absolute top-20 right-6 z-20 flex gap-3">
				...
				<div className="relative z-10 text-center px-4">
					...
					<h1 className="text-8xl md:text-9xl font-black mb-6 tracking-tighter">
						<span className="bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">{artist.name}</span>
					</h1>
					...
					<div className="flex justify-center gap-4 flex-wrap">
						{artist.genres.map((genre) => (
							<span key={genre} className="px-5 py-2 bg-cyan-500/20 border border-cyan-500/30 rounded-full text-cyan-300 font-mono text-sm">
								{genre}
							</span>
						))}
					</div>
...
{/* 
			...
			<section className="py-32 relative overflow-hidden">
				...
				<div className="container mx-auto px-4 text-center relative z-10">
					...
					<p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">Available for features, live shows, studio sessions, and collaborations</p>
					<Link href="mailto:manager@billionentertainment.co.in">
						<Button size="lg" className="bg-cyan-500 hover:bg-cyan-400 text-gray-900 font-black text-lg px-12 py-6 rounded-full">
