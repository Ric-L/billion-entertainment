          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
              {artist.embedded.map((embed, i) => (
                <div key={i} className="aspect-video rounded-xl overflow-hidden border-2 border-amber-600/30">
                  <iframe
                    src={embed}
            ...
            <div className="md:col-span-2 bg-amber-600/10 border border-amber-600/30 rounded-2xl p-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                {artist.influences?.map((influence) => (
                  <div
                    key={influence}
                    className="bg-black/50 px-4 py-3 rounded-lg text-center font-medium border border-amber-600/20"
                  >
                    {influence}
                  </div>
                ))}
      ...
      <section id="contact" className="py-20 border-t border-amber-600/30">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-400 mb-12 max-w-2xl mx-auto">
            Available for live performances, studio sessions, and collaborations.
          </p>
          <div className="flex justify-center gap-6 mb-12">
            {artist.socials.spotify && (
              <a
                ...
                className="w-14 h-14 rounded-full bg-amber-600 flex items-center justify-center hover:bg-amber-500 transition-colors"
              >
