...
import { Instagram, Youtube, Music, ArrowLeft, Mail } from "lucide-react"
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex flex-wrap gap-4">
                {artist.influences.map((influence) => (
                  <div
                    key={influence}
                    className="px-6 py-3 bg-white border-2 border-orange-300 rounded-lg text-lg font-medium text-gray-800"
                  >
                    {influence}
                  </div>
                ))}
