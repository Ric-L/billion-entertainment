				...
				<section id="unreleased" className="py-20 bg-gradient-to-b from-emerald-50 to-white">
					<div className="container mx-auto px-4">
						<h2 className="text-5xl font-bold mb-12 text-center text-gray-900">
							<span className="text-emerald-600">Unreleased</span> Tracks
						</h2>
						...
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
							{artist.unreleased.map((track, index) => (
								<div
									key={index}
									className="bg-white rounded-3xl border border-emerald-200 shadow-xl p-6 flex flex-col items-center gap-4 transition-shadow hover:shadow-2xl"
								>
