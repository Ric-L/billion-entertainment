			...
			<div className="absolute inset-0">
				...
				<div key={videos[currentIndex].id} className="absolute inset-0 transition-opacity duration-1000 opacity-100">
					<div className="video-bg">
						<iframe
							src={`https://www.youtube.com/embed/${videos[currentIndex].id}?start=90&autoplay=1&mute=1&loop=1&playlist=${videos[currentIndex].id}&controls=0&rel=0&iv_load_policy=3&modestbranding=1&playsinline=1&disablekb=1&fs=0`}
